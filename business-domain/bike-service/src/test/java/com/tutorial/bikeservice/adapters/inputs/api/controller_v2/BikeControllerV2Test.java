...
class BikeControllerV2Test {
    ...
    @Captor
    private ArgumentCaptor<NewBikeDtoV2> newBikeCaptor;
    ...
    void testGetAll_ReturnsListOfBikes() {
        ...
        // Given
        List<BikeDtoV2> expectedResponse = new ArrayList<>();
        Long id1 = 1L;
        String brand1 = "Honda";
        String model1 = "CBR";
        Long userId = 1L;
        expectedResponse.add(BikeDtoV2.builder().id(id1).brand(brand1).model(model1).userId(userId).build());

        Long id2 = 2L;
        String brand2 = "Yamaha";
        String model2 = "R1";
        Long userId2 = 2L;
        expectedResponse.add(BikeDtoV2.builder().id(id2).brand(brand2).model(model2).userId(userId2).build());
    ...
    void testGetById_ReturnExistingBike() {
        ...
        String model = "CBR";
        Long userId = 1L;
        BikeDtoV2 bikeReturned = BikeDtoV2.builder().id(id).brand(brand).model(model).userId(userId).build();
